...
export default function CatForm(props) {
    ...
    const handleSubmit = (values) => {
        ...
        if(!props.category){
            ...
            axios.post(`https://localhost:7284/api/Categories`, catToCreate).then(() => {
            ...
            axios.put(`https://localhost:7284/api/Categories/${[props.category.categoryId]}`, catToEdit).then(() => {
    ...
    <div className='createCategory m-2 text-white text-center'>
        <Formik
            initialValues={{
                ...
                catDescr: props.category ? props.category.catDesc : '',
            }}
